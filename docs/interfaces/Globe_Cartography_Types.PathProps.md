...
[src/components/cartography/types.ts:17](https://github.com/Gaushao/d3-react-globe/blob/0a8a5c1/src/components/cartography/types.ts#L17)
...
• `Optional` **onResize**: `ReactEventHandler`<`SVGPathElement`\>

#### Inherited from

React.SVGProps.onResize
...
• `Optional` **onResizeCapture**: `ReactEventHandler`<`SVGPathElement`\>

#### Inherited from

React.SVGProps.onResizeCapture
...
node_modules/@types/react/index.d.ts:2777
...
node_modules/@types/react/index.d.ts:2775
...
node_modules/@types/react/index.d.ts:2776
...
node_modules/@types/react/index.d.ts:2780
